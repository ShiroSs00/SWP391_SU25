...
import static com.swp391.bloodcare.dto.DonorFeedbackDTO.*;
...
public class FeedbackService {
    ...
    public Map<String, Object> getDashboardSummary() {
        ...
        result.put("averageProcess", all.stream().mapToLong(DonorFeedback::getProcess).average().orElse(0));
        result.put("averageBloodTest", all.stream().mapToLong(DonorFeedback::getBloodTest).average().orElse(0));
        result.put("averagePostCare", all.stream().mapToLong(DonorFeedback::getPostDonationCare).average().orElse(0));
        result.put("averageComfortable", all.stream().mapToLong(DonorFeedback::getComfortable).average().orElse(0));
