        ...
        <section className="py-24 bg-white">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-16">
                    {bloodTypes.map((bloodType, index) => (
                        ...
                        >
                            ...
                            <div className="text-center mb-4">
                                <Badge
                                    variant={bloodType.percentage <= 2 ? 'warning' : bloodType.percentage <= 10 ? 'success' : 'success'}
                                    size="sm"
                                >
                                    {bloodType.rarity}
                                </Badge>
                ...
                <div className="text-center animate-slide-up">
                    <Card variant="elevated" padding="lg" className="bg-gradient-to-r from-blood-600 to-blood-800 text-white">
