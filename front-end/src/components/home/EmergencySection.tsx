...
export function EmergencySection() {
    ...
    const getUrgencyBadge = (urgency: string) => {
        const variants = {
            ...
            high: { variant: 'urgent' as const, label: 'Khẩn cấp', pulse: false },
            ...
            <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
              ...
              Khẩn cấp
                ...
                <div className="mb-16 animate-slide-up">
                    <Card variant="elevated" padding="lg" className="bg-emergency-600/20 backdrop-blur-md border-emergency-500/30">
