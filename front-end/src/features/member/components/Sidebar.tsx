    ...
    <div className="w-64 bg-white shadow-xl h-screen fixed left-0 top-0 z-20 border-r border-gray-100">
      ...
      <div className="p-6 border-b border-gray-100 bg-gradient-to-r from-red-50 to-pink-50">
        <div className="flex items-center space-x-3">
          ...
          <div>
            <h1 className="text-xl font-bold text-gray-800 tracking-tight">BloodConnect</h1>
          ...
          {menuItems.map((item) => {
            ...
            return (
              <Link
                ...
                className={`group w-full flex items-center justify-between px-4 py-3 text-left rounded-xl transition-all duration-200 ease-in-out transform hover:scale-[1.02] ${
                  isActive
